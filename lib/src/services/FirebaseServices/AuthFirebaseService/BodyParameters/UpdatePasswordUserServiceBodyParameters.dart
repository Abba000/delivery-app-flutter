...
class UpdatePasswordBodyParameters {
  UpdatePasswordBodyParameters(
      {required this.requestType, required this.email});
  ...
  factory UpdatePasswordBodyParameters.fromMap(Map<String, dynamic> json) =>
      UpdatePasswordBodyParameters(
          requestType: json["requestType"], email: json["email"]);

  Map<String, dynamic> toMap() => {"requestType": requestType, "email": email};
}
