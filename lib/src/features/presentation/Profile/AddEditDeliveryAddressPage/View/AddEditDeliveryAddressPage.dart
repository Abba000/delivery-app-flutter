// ignore_for_file: must_be_immutable, file_names, library_private_types_in_public_api, invalid_use_of_protected_member
  ...
  _showAlertDeleteDeliveryAddress(BuildContext context) {
    AlertView.showAlertDialog(
        model: AlertViewModel(
            ...
            "",
            "Are you sure to remove this shipping address?",
            "Delete",
            "Cancel", () {
      // CTA ACTION
