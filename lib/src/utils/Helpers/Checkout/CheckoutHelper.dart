...
import '../../../features/domain/Entities/DeliveryAddress/DeliveryAddressEntity.dart';
import '../../../features/domain/Entities/PaymentMethods/PaymentMethodsEntity.dart';
...
class CheckoutHelper {
  ...
  static DeliveryAddressListEntity getMainDeliveryAddress(
    ...
    newEntity.deliveryAddressList = entity.deliveryAddressList
        ...
        .where((address) => address != null) // Filtrar valores no nulos
        .cast<
            DeliveryAddressEntity>() // Cast de tipo para que Dart sepa que no son nulos
        .toList();
    return newEntity;
  }
  ...
  static PaymentMethodsEntity getMainPaymentMethods(
    ...
    newEntity.paymentMethods = entity.paymentMethods
        ...
        .where((address) => address != null) // Filtrar valores no nulos
        .cast<
            PaymentMethodEntity>() // Cast de tipo para que Dart sepa que no son nulos
        .toList();
    return newEntity;
  }
}
